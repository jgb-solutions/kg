<div class="btn-group btn-group-justified btn-group-lg">
    ...
    <a
        ...
        href="http://twitter.com/share?url={{ Config::get('site.url') }}&amp;text={{ Config::get('site.name') }}&amp;via={{ Config::get('site.twitter') }}">
        <strong>
    ...
    <a
        ...
        href="whatsapp://send?text={{ Config::get('site.name') }} {{ Config::get('site.url') }} via {{ Config::get('site.twitter') }}">
        <strong>
