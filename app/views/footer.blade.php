		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<h4>
							...
							Gen <span class="count">{{ $count }}</span> mizik Keeng ki gentan telechaje gratis ak sèvis nou an.
						</h4>
					</div>
					@endif
			...
			<div class="col-sm-6">
				<div class="row">
	                ...
	                <div class="col-xs-4">
	                	<a
	                		href="https://plus.google.com/101945064110608448547"
	                		target="_blank"
	                		class="btn btn-danger btn-large btn-block"
	                		title="Swiv Keeng Gratis sou Google+">
